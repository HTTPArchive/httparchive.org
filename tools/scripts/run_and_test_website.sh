...
######################################
## Custom HTTP Ardchive script      ##
######################################
#
# This script installs all the required dependencies needed to run the
# HTTP Ardhive website providing you have python and node installed.
#
...
Usage: ${0##*/} [-hd]
This script installs all the required dependencies needed to run the
HTTP Archive website providing you have python and node installed.
