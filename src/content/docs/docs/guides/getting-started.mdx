...
11. Change the query to take a small sample of the table (e.g. `SELECT *`), click the `RUN` button and you should see the results of your query.
    ...
    See the guide on [minimizing query costs](/docs/guides/minimizing-costs/) to learn more.
...
* [`httparchive.crawl.pages`](/docs/reference/tables/pages/) - HAR extract for each page url.

* [`httparchive.crawl.requests`](/docs/reference/tables/requests/) - HAR extract for each resource.
...
To explore more interactive examples, read the [Guided Tour](/docs/guides/guided-tour/).
