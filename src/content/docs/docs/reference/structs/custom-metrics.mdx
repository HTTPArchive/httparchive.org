...
_As [`custom_metrics`](/docs/reference/tables/pages/#custom_metrics)_
...
`privacy` | `JSON` | Privacy settings and policies. See the [`privacy`](/docs/reference/custom-metrics/privacy/) custom metrics for more information
...
`other` | `JSON` | See the [other](/docs/reference/custom-metrics/other/) custom metrics for more information
...
Privacy settings and policies. See the [`privacy`](/docs/reference/custom-metrics/privacy/) custom metrics for more information.
...
See the [other](/docs/reference/custom-metrics/other/) custom metrics for more information.
