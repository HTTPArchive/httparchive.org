...
Response bodies can be sourced from the `response_body` field of the [`requests`](/docs/reference/tables/requests/) table, or the `body` field of legacy `response_bodies` tables.
